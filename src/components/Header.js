...
const Header = () => {
  ...
  return (
    <div className="grid grid-flow-col p-3 shadow-md text-black dark:text-white bg-white dark:bg-black">
      <div className="flex col-span-1">
        ...
        <a href="/">
          <svg
            className="external-icon fill-current text-black dark:text-white"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="col-span-10 pr-40">
        <div>
          <input
            className="w-5/6 border border-gray-400 rounded-l-full p-1 px-4 focus:outline-0 text-black dark:text-white bg-white dark:bg-black"
            type="text"
            value={searchQuery}
            ...
            placeholder="Search"
          />
          <button className="border border-gray-400 rounded-r-full px-4 py-1 bg-slate-100 dark:bg-black">
            🔍
          </button>
        </div>
        {showSuggestions && (
          <div className="fixed bg-white dark:bg-black text-black dark:text-white px-5 w-[33.5rem]">
            <ul>
              {suggestions.map((s) => (
                <li key={s} className="py-1 hover:bg-gray-200">
                  🔍 {s}
                </li>
              ))}
            </ul>
      ...
      <Avatar name="Harshit Verma" size="40" round={true} />
        <DynamicTheme />
      </div>
    </div>
  );
